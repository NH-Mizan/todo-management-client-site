...
import useAxiosPublic from "../CastomHooks/useAxiosPublic";
import useAuth from "../CastomHooks/useAuth";
// import AllTask from "../CastomHooks/AllTask";
...
const TaskAdd = () => {
    ...
    const handleTaskAdd = async (e) => {
        ...
        try {
            const res = await axiosPublic.post("http://localhost:5000/tasks", taskData);
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
                        ...
                        <form onSubmit={handleTaskAdd}>
                            ...
                            <div className="flex justify-between">
                                ...
                                <button
                                    type="submit"
                                    className="btn bg-blue-600 text-white py-2 px-4 rounded"
                                >
                                    Add Task
                                </button>
                            </div>
